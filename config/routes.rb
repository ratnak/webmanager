WebApp::Application.routes.draw do
  ...
  match "/logout", :to => "user_sessions#destroy", :as => :logout,     :via => [:get, :delete]
  root :to => "user_sessions#new",     :as => :login,      :via => :get
