...
authorization do
  ...
  role :member do
	...
	has_permission_on :website_menu_item, :to => :manage
  ...
  role :administrator do
	...
	has_permission_on :main_menus, :to => :manage
	has_permission_on :website_menu_items, :to => :manage
    has_permission_on :users,:website_menu_item, :to => :delete do
